...
def main() -> None:
    ...
    policies = {
        ...
        "local.claude-code": ("private", "scrub", {"brain", "source"}),
        "local.codex": ("private", "scrub", {"brain", "source"}),
        "local.cowork": ("private", "scrub", {"brain", "source"}),
        "local.chatgpt-export": ("private", "scrub", {"brain", "source"}),
    ...
    tests = {
        ...
        "local.claude-code": "e2e_codex_projection.py",
        "local.codex": "e2e_codex_projection.py",
        "local.cowork": "e2e_codex_projection.py",
        "local.chatgpt-export": "e2e_export_inbox.py",
